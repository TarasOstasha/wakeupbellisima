...
let scrape = async () => { // Prepare scrape...
  ...
  await page.waitFor(1000); // In case Server has JS needed to be loaded...
    ...
    const result = await page.evaluate(() => { // Let's create variables and store values...
        ...
        // let reviewsWrapper = document.querySelector('.gws-localreviews__general-reviews-block');
        // document.querySelectorAll('.gws-localreviews__general-reviews-block').forEach(function(node) {
        ...
        //             //     console.log(ITEM.innerText, '---ITEM')
        //             // })
        //             //const myNodeList2 = document.querySelector('.jxjCjc');
        //                 console.log(item.childNodes[0])
        //                 let fullName = item.childNodes[0].innerText
